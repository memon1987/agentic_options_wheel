...
**Scope:** shared (backtest engine)
**Status:** Plan APPROVED 2026-09-11 (`docs/plans/fc-116.md` rev 3 — two adversarial plan reviews, union addressed in rev 2, scoped confirmation's per-leg delta-law contradiction fixed in rev 3). Opus build next; FC-117's build follows. Operator decisions 2026-09-11: proceed; `limit` is the default fill mode; named `ENGINE_VERSION` bump.
**Size estimate:** S–M
