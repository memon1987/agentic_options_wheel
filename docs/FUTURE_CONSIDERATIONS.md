...
- **C — covered-call selector (build gate LIFTED 2026-09-08: re-seed at next close; FC-100 wires rolling first):** `strategy` field in the spec; profile-aware replay; synthetic-lot seeding; CC gating honoured in the engine.
...
**Scope:** shared
**Status:** MERGED — PR #128 `7c22fac` 2026-09-09 (both bot services → 1800 s; seam-invariant contract test); live verification pending the build, then FC-100 O8/O9 may proceed. Found by the FC-100 plan; live-verified on both services.
