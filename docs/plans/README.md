...
_All plan files, regenerated 2026-08-28 (night) from each file's `**Status:**` line (pr-body drafts omitted)._
...
- [fc-096-d.md](fc-096-d.md) — FC-096 Phase D — IAP over the dashboard: Google SSO, operator/viewer roles, token retirement, status: Draft
